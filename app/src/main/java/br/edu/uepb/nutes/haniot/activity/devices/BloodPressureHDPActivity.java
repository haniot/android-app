...
import static br.edu.uepb.nutes.haniot.utils.DateUtils.timeStamp;
...
public class BloodPressureHDPActivity extends AppCompatActivity {
    ...
    private MeasurementBloodPressureDAO measurementBloodPressureDAO;
    private DeviceClientDAO deviceDAO;

    MeasurementBloodPressure measurement;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        measurementBloodPressureDAO = MeasurementBloodPressureDAO.getInstance(this);
...
//		}
    ...
    private Deviceshdp device = new Deviceshdp() {
        ...
        public void disconnect() {
             ...
             */
            if (measurementBloodPressureDAO.save(measurement))
                sendMeasurementToServer();
        }

        @Override
        public void receiveData() {
            measurement = new MeasurementBloodPressure();
    ...
    private void sendMeasurementToServer() {
        ...
        List<MeasurementBloodPressure> measurementBloodPressureNotSent = measurementBloodPressureDAO.getNotSent(mDevice.getAddress(), session.getIdLogged());
        ...
        for (final MeasurementBloodPressure m : measurementBloodPressureNotSent) {
            ...
            Server.getInstance(this).post("healths", jsonObject.toString(), headers, new Server.Callback() {
                ...
                public void onSuccess(JSONObject result) {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            m.setHasSent(1);
                            measurementBloodPressureDAO.update(m);
                        }
                    });
                }
            });
