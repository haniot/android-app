...
import br.edu.uepb.nutes.haniot.data.objectbox.nutritional.MedicalRecordOB_;
...
//    save FeedingHabitsRecordOB
    public boolean save(@NonNull MedicalRecord medicalRecord){
        return medicalRecordBox.put(new MedicalRecordOB(medicalRecord)) > 0;
    }
