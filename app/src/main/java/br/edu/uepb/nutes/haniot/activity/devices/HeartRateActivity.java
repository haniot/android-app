...
public class HeartRateActivity extends AppCompatActivity implements View.OnClickListener, HeartRateAdapter.OnItemClickListener {
    ...
    private List<MeasurementHeartRate> listMeasurementHeartRate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         * Recycler view
         */
        listMeasurementHeartRate = new ArrayList<>();
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mAdapter = new HeartRateAdapter(listMeasurementHeartRate, this, this);
    ...
    private void refreshRecyclerView() {
        listMeasurementHeartRate.clear();

        for (MeasurementHeartRate m : measurementHeartRateDAO.list(mDeviceAddress, session.getIdLogged(), 0, 10)) {
            listMeasurementHeartRate.add(m);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        mHeartRateTextView.setText(String.format("%03d", measurement == null ? 0 : measurement));
                    }
                }, 1000);
            }
        }
