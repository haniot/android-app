 ...
 */
public class PageRadioBack extends Fragment implements ISlideBackgroundColorHolder {
    ...
    protected static final String ARG_IMAGE_DRAWABLE = "arg_drawable";
     ...
     * @return PageRadio
     */
    private static PageRadioBack newInstance(ConfigPage configPage) {
        PageRadioBack pageFragment = new PageRadioBack();
        ...
        args.putInt(ARG_IMAGE_DRAWABLE, configPage.image);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null && getArguments().size() != 0) {
            ...
            drawable = getArguments().getInt(ARG_IMAGE_DRAWABLE);
    ...
    public static class ConfigPage {
        ...
        public ConfigPage() {
            this.layout = R.layout.question_radio_theme_dark;
            this.title = 0;
            this.description = 0;
            this.image = 0;
         ...
         * @return ConfigPage
         */
        public ConfigPage image(@DrawableRes int image) {
            this.image = image;
            return this;
        }
         ...
         * @return ConfigPage
         */
        public ConfigPage buttonClose(int drawableClose) {
            this.drawableClose = drawableClose;
            return this;
        }

        public Fragment build() {
            return PageRadioBack.newInstance(this);
        }
    }
