...
public class BodyCompositionGraphActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    @BindView(R.id.chart_bodyComposition)
    LineChart mChart;
    ...
    private void requestData(String period) {
        ...
        hist.request(this, new CallbackHistorical<Measurement>() {
            ...
            public void onResult(List<Measurement> result) {
                Log.w(TAG, "onSuccess()" + Arrays.toString(result.toArray()));
    ...
    private void paintChart() {
        ...
        LineDataSet set = new LineDataSet(entries, getString(R.string.body_mass));
        set.setLineWidth(3f);
