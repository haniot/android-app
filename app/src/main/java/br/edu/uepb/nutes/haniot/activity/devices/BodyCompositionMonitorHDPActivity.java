...
import br.edu.uepb.nutes.haniot.model.MeasurementBodyCompositionMonitor;
...
public class BodyCompositionMonitorHDPActivity extends AppCompatActivity {
    ...
    private MeasurementBodyCompositionMonitor measurement;
...
//            if (MeasurementBodyCompositionMonitorDAO.getInstance().save(measurement) > 0)
        ...
        public void receiveData() {
            measurement = new MeasurementBodyCompositionMonitor();
...
//        }
    ...
    private void sendMeasurementToServer(final MeasurementBodyCompositionMonitor measurementBodyCompositionMonitor) {
        ...
        JsonObject jsonMeasurement = (JsonObject) gson.setFieldNamingPolicy(FieldNamingPolicy.IDENTITY).create().toJsonTree(measurementBodyCompositionMonitor);
