...
import br.edu.uepb.nutes.haniot.data.model.objectbox.MeasurementLastResponse;
import br.edu.uepb.nutes.haniot.data.model.objectbox.NutritionalEvaluation;
...
import br.edu.uepb.nutes.haniot.data.model.objectbox.TypeEvaluation;
...
import static br.edu.uepb.nutes.haniot.data.model.objectbox.ItemEvaluation.TYPE_EMPTY_REQUIRED;
import static br.edu.uepb.nutes.haniot.data.model.objectbox.ItemEvaluation.TYPE_ERROR;
import static br.edu.uepb.nutes.haniot.data.model.objectbox.ItemEvaluation.TYPE_LOADING;
import static br.edu.uepb.nutes.haniot.data.model.objectbox.ItemEvaluation.TYPE_MEASUREMENT;
import static br.edu.uepb.nutes.haniot.data.model.objectbox.ItemEvaluation.TYPE_QUIZ;
import static br.edu.uepb.nutes.haniot.data.model.objectbox.TypeEvaluation.ALL_MEASUREMENT;
import static br.edu.uepb.nutes.haniot.data.model.objectbox.TypeEvaluation.ALL_QUIZ;
import static br.edu.uepb.nutes.haniot.data.model.objectbox.TypeEvaluation.BLOOD_PRESSURE;
import static br.edu.uepb.nutes.haniot.data.model.objectbox.TypeEvaluation.FEEDING_HABITS;
import static br.edu.uepb.nutes.haniot.data.model.objectbox.TypeEvaluation.GLUCOSE;
import static br.edu.uepb.nutes.haniot.data.model.objectbox.TypeEvaluation.HEARTRATE;
import static br.edu.uepb.nutes.haniot.data.model.objectbox.TypeEvaluation.HEIGHT;
...
import static br.edu.uepb.nutes.haniot.data.model.objectbox.TypeEvaluation.WAIST_CIRCUMFERENCE;
import static br.edu.uepb.nutes.haniot.data.model.objectbox.TypeEvaluation.WEIGHT;
