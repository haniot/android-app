...
{
	fprintf(stderr, "Medical Device System Data Updated (ContextMeasurement %u:%llx):\n",
...
{
	fprintf(stderr, " Medical Device System Associated (ContextMeasurement %u:%llx):\n",
			ctx->id.plugin, ctx->id.connid);
}
